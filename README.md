      ...
      cameras: [
        {
          ...
          streamPassword: "__STREAM_PASSWORD__", // Make sure that this is only [A-Za-z0-9], no special chars allowed!
          streamUser: "__STREAM_USER__", // Make sure that this is only [A-Za-z0-9], no special chars allowed!
